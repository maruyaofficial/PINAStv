...
}, // Example Image URL
{
    ...
    id: 'natgeowild',
    name: "Nat Geo Wild",
    manifest: 'https://uselector.cdn.intigral-ott.net/NHD/NHD.isml/manifest.mpd',
    drm: {
        type: 'clearkey',
    ...
    id: 'natgeo',
    name: "Nat Geo",
    manifest: 'https://uselector.cdn.intigral-ott.net/NGO/NGO.isml/manifest.mpd',
    drm: {
        type: 'clearkey',
    ...
    name: "ANC",
    manifest: 'https://amagivercel.vercel.app/api/proxy?url=https://cdn-ue1-prod.tsv2.amagi.tv/linear/amg01006-abs-cbn-anc-global-dash-abscbnono/index.mpd',
    drm: {
        type: 'clearkey',
    ...
    name: "GMA Pinoy TV",
    manifest: 'https://amagivercel.vercel.app/api/proxy?url=https://cdn-uw2-prod.tsv2.amagi.tv/linear/amg01006-abs-cbn-abscbn-gma-x7-dash-abscbnono/index.mpd',
    drm: {
        type: 'clearkey',
    ...
    name: "Myx",
    manifest: 'https://amagivercel.vercel.app/api/proxy?url=https://cdn-ue1-prod.tsv2.amagi.tv/linear/amg01006-abs-cbn-myxnola-dash-abscbnono/index.mpd',
    drm: {
        type: 'clearkey',
    ...
    manifest: 'https://amagivercel.vercel.app/api/proxy?url=https://cdn-ue1-prod.tsv2.amagi.tv/linear/amg01006-abs-cbn-teleradyo-dash-abscbnono/index.mpd',
    drm: {
        type: 'clearkey',
    ...
    name: "TFC",
    manifest: 'https://amagivercel.vercel.app/api/proxy?url=https://cdn-ue1-prod.tsv2.amagi.tv/linear/amg01006-abs-cbn-tfcasia-dash-abscbnono/index.mpd',
    drm: {
        type: 'clearkey',
    ...
    name: "Eurosport 1",
    manifest: 'https://proxy.reusora.org/api/channel/eurosport1/manifest.mpd',
    drm: {
        type: 'widevine',
        licenseUri: 'https://proxy.reusora.org/api/widevine/special/key'
    }
}, {
    name: "Eurosport 2", 
    manifest: 'https://proxy.reusora.org/api/channel/eurosport1/manifest.mpd',
    ...
    name: "Aniplus",
    manifest: 'https://proxy.reusora.org/api/stream/aniplus/manifest.m3u8',
    drm: {
        type: 'playready',
        licenseUri: 'https://proxy.reusora.org/api/playready/aniplus'
    }
}, {
    name: "Arirang",
    ...
    name: "Friday",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Friday/HLSv3-FTA/Friday.m3u8',
    drm: null
}, {
    name: "Khugjim",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Khugjim/HLSv3-FTA/Khugjim.m3u8',
    drm: null
}, {
    name: "Lotus",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Lotus/HLSv3-FTA/Lotus.m3u8',
    drm: null
}, {
    name: "Malchin",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Malchin/HLSv3-FTA/Malchin.m3u8',
    drm: null
}, {
    name: "Match Planeta",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Match_Planeta/HLSv3-FTA/Match_Planeta.m3u8',
    drm: null
}, {
    name: "MIR",
    manifest: 'https://cdn4.skygo.mn/live/disk1/MIR/HLSv3-FTA/MIR.m3u8',
    drm: null
}, {
    name: "MN25",
    manifest: 'https://cdn4.skygo.mn/live/disk1/MN25/HLSv3-FTA/MN25.m3u8',
    drm: null
}, {
    name: "MNB",
    manifest: 'https://cdn4.skygo.mn/live/disk1/MNB/HLSv3-FTA/MNB.m3u8',
    drm: null
}, {
    name: "MNB World",
    manifest: 'https://cdn4.skygo.mn/live/disk1/MNB_World/HLSv3-FTA/MNB_World.m3u8',
    drm: null
}, {
    name: "MNCTV",
    manifest: 'https://cdn4.skygo.mn/live/disk1/MNCTV/HLSv3-FTA/MNCTV.m3u8',
    drm: null
}, {
    name: "Moviebox",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Moviebox/HLSv3-FTA/Moviebox.m3u8',
    drm: null
}, {
    name: "NHK World",
    manifest: 'https://cdn4.skygo.mn/live/disk1/NHK_World/HLSv3-FTA/NHK_World.m3u8',
    drm: null
}, {
    name: "NHK World Premium",
    manifest: 'https://cdn4.skygo.mn/live/disk1/NHK_World_Premium/HLSv3-FTA/NHK_World_Premium.m3u8',
    drm: null
}, {
    name: "ONTV",
    manifest: 'https://cdn4.skygo.mn/live/disk1/ONTV/HLSv3-FTA/ONTV.m3u8',
    drm: null
}, {
    name: "Parlament",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Parlament/HLSv3-FTA/Parlament.m3u8',
    drm: null
}, {
    name: "Pobeda",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Pobeda/HLSv3-FTA/Pobeda.m3u8',
    drm: null
}, {
    name: "Popcorn",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Popcorn/HLSv3-FTA/Popcorn.m3u8',
    drm: null
}, {
    name: "RenTV",
    manifest: 'https://cdn4.skygo.mn/live/disk1/RenTV/HLSv3-FTA/RenTV.m3u8',
    drm: null
}, {
    name: "SBN",
    manifest: 'https://cdn4.skygo.mn/live/disk1/SBN/HLSv3-FTA/SBN.m3u8',
    drm: null
}, {
    name: "THT",
    manifest: 'https://cdn4.skygo.mn/live/disk1/THT/HLSv3-FTA/THT.m3u8',
    drm: null
}, {
    name: "TV Center",
    manifest: 'https://cdn4.skygo.mn/live/disk1/TV_center/HLSv3-FTA/TV_center.m3u8',
    drm: null
}, {
    name: "TV4",
    manifest: 'https://cdn4.skygo.mn/live/disk1/TV4/HLSv3-FTA/TV4.m3u8',
    drm: null
}, {
    name: "TV7",
    manifest: 'https://cdn4.skygo.mn/live/disk1/TV7/HLSv3-FTA/TV7.m3u8',
    drm: null
}, {
    name: "Vremya",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Vremya/HLSv3-FTA/Vremya.m3u8',
    drm: null
}, {
    name: "Zoomoo",
    manifest: 'https://cdn4.skygo.mn/live/disk1/Zoomoo/HLSv3-FTA/Zoomoo.m3u8',
    drm: null
}, {
    name: "Disney XD (TEST)",
    manifest: 'https://proxy.reusora.org/api/channel/disney/manifest.m3u8',
    drm: null
...
if (channel.manifest && channel.manifest.includes('qp-pldt-live-grp')) {
    try {
        ...
        if (match) {
            ...
            channel.manifest = `https://proxy.reusora.org/api/akamai/${groupName}/${manifestName}`;
        }
    } catch (e) {
